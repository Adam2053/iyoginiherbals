...
const Product = () => {
  ...
  return (
    <div>
      {product.map((p,i) => (
        <div className="px-[9rem] py-[4rem]" title={p.pro} key={i}>
            ...
            <div className="flex flex-col justify-center gap-2">
              ...
              <div>
                ...
                <h2 className="mb-5 text-[#000000] font-bold text-3xl">
                  INR 499.00{" "}
                  <span className="text-xl">{"(incl. of all taxes)"}</span>
                </h2>
              </div>
              <img src={cards} alt="" />
              <div>
